    ...
    <div class="container mx-auto">
        <div class="flex flex-col md:flex-row justify-between">
            <div class="mb-6 md:mb-0">
                <h2 class="text-xl font-bold mb-2">Juan Desarrollador</h2>
                <p class="text-gray-300">Desarrollador Web Full Stack</p>
                <p class="text-gray-400 mt-4">© <?php echo date('Y'); ?> - Todos los derechos reservados</p>
            </div>
            <div>
                <h3 class="text-lg font-semibold mb-2">Contacto</h3>
                <ul class="text-gray-300">
                    <li class="mb-1">Email: contacto@juandesarrollador.com</li>
                    <li class="mb-1">Teléfono: +34 600 000 000</li>
                    <li class="mb-1">Ubicación: Madrid, España</li>
                </ul>
            </div>
