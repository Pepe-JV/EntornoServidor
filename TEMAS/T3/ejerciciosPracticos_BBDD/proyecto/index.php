...
<body>
    <div class="card">
        ...
        <h2>📝 Ejercicios Prácticos (Terminal)</h2>
        <div class="info">
            <p>Los ejercicios están diseñados para ejecutarse desde la terminal:</p>
            <ul>
                <li><code>docker exec -it ejerciciospracticos_bbdd-web-1 php ejercicio1.php</code></li>
                <li><code>docker exec -it ejerciciospracticos_bbdd-web-1 php ejercicio2.php</code></li>
                <li><code>docker exec -it ejerciciospracticos_bbdd-web-1 php ejercicio3.php</code></li>
                <li><code>docker exec -it ejerciciospracticos_bbdd-web-1 php ejercicio4.php</code></li>
                <li><code>docker exec -it ejerciciospracticos_bbdd-web-1 php ejercicio5.php</code></li>
            </ul>
        </div>
    </div>
</body>
